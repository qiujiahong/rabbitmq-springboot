...
//    final static String QUEUE_EVENT = "eventQueue";
...
//        return new Queue(TopicConfig.QUEUE_EVENT);
//    }
//
//    // 配置交换器
//    @Bean
...
//
//    @Bean
//    Binding bindingtopicExchangeEvent(Queue queueEvent, TopicExchange topicExchange) {
//        return BindingBuilder.bind(queueEvent).to(topicExchange).with("event.parking.#");
//    }
}
